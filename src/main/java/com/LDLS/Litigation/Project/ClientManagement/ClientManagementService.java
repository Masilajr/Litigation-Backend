...
public class ClientManagementService {
    ...
    private ClientManagementDTO convertToDTO(ClientManagement client) {
        ...
        dto.setKraPin(client.getKraPin());
        dto.setEmailAddr(client.getEmailAddr());
        dto.setPhoneNo1(client.getPhoneNo1());
        dto.setPhoneNo2(client.getPhoneNo2());
        dto.setPostalAddress(client.getPostalAddress());
        ...
        dto.setLoanAccNo(client.getLoanAccNo());
        dto.setOriginalLoanAmount(client.getOriginalLoanAmount());
        dto.setInterestRate(client.getInterestRate());
        dto.setStartDate(client.getStartDate());
        dto.setEndDate(client.getEndDate());
        dto.setOutPrincipal(client.getOutPrincipal());
        dto.setOutInterest(client.getOutInterest());
        dto.setLastAccrualDate(client.getLastAccrualDate());
        dto.setLastPaymentDate(client.getLastPaymentDate());
        dto.setLastPayReceived(client.getLastPayReceived());
        dto.setLastIntAppDate(client.getLastIntAppDate());
        dto.setUserAssetClass(client.getUserAssetClass());
        dto.setClassificationDate(client.getClassificationDate());
        dto.setLoanTenor(client.getLoanTenor());
        dto.setDefaultReason(client.getDefaultReason());
        dto.setDefaultDate(client.getDefaultDate());
        dto.setTransferringOffice(client.getTransferringOffice());
        dto.setAmountRemaining(client.getAmountRemaining());
        dto.setLoanDescription(client.getLoanDescription());
        dto.setDepartment(client.getDepartment());
        dto.setOfficer(client.getOfficer());
        dto.setDeadline(client.getDeadline());
        dto.setPriority(client.getPriority());
        dto.setAdditionalInfo(client.getAdditionalInfo());
        dto.setTotalClients(client.getTotalClients());
        dto.setActiveClients(client.getActiveClients());
        dto.setPendingClients(client.getPendingClients());
        dto.setLitigationClients(client.getLitigationClients());
